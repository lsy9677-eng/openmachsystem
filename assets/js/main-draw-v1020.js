...
(function(){
  ...
  const VERSION = 'v1020-no-repeat-toast-balanced-queue-fix';
  ...
  async function refreshLiveMainQueue(key, reason){
    ...
    const manualReason=/manual|button|assign|force/i.test(reasonText);
    let changed=false;
...
(function(){
  ...
  try{console.log('[v1020] staged queue watchdog installed');}catch(e){}
})();
