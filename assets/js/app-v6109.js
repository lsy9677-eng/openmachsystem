...
(function stage6001UnifiedTournamentEditor(){
  ...
  async function saveAll(){
    ...
    try{
      ...
      state.portal=state.portal||{};state.portal.guide={...(state.portal.guide||{}),date:d.querySelector('#s6001Date')?.value||'',startTime:d.querySelector('#s6001Time')?.value||'09:00',venue:d.querySelector('#s6001Venue')?.value||''};
