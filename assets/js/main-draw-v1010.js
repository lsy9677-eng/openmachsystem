/* v1010 cache-proof clean main draw slot mode
...
(function(){
  ...
  // v1010 uses its own guard so it can replace a cached v1008/v1009 script if a service worker returns an old asset.
  const VERSION = 'v1010-cache-proof-main-draw';
  ...
  install();
  function apply(){ensurePanel();hideLegacyMainUi();forcePanelVisible();}
  ...
  try{console.log('[v1010] cache-proof slot main draw loaded');}catch(e){}
})();
...
(function(){
  ...
  var VERSION='v1010-button-cache-proof';
  function $(id){return document.getElementById(id);}
  ...
  try{console.log('[v1010] main draw buttons cache-proof fixed');}catch(e){}
})();
