...
import{startStateSync,getSyncSettings,saveSyncSettings,connectCloudSync,disconnectCloudSync,pushStateNow,pullStateNow,testCloudConnection,prepareCriticalCloudWrite,deleteTournamentNow}from'./sync-engine-v6000.js?v=6000';
...
(function(){
  ...
  function renderVisibleDivisionBar(){
      ...
      <div class="division-v6002-grid">
        ${divisions.map((d,i)=>{
          ...
          const quick=active?`<div class="division-v6003-quick" data-v6003-quick-wrap>
            ${admin?`<button type="button" data-v6003-go="entry">참가 승인</button><button type="button" data-v6003-go="roster">참가팀</button><button type="button" data-v6003-go="prelim-public">예선</button><button type="button" data-v6003-go="operation">코트</button><button type="button" data-v6003-go="bracket">본선</button><button type="button" data-v6003-more>더보기</button>`:`<button type="button" data-v6003-go="entry">참가 신청</button><button type="button" data-v6003-go="my-match">내 경기</button><button type="button" data-v6003-go="prelim-public">예선 현황</button><button type="button" data-v6003-go="operation">코트 현황</button><button type="button" data-v6003-go="bracket">본선 대진표</button>`}
            ${admin?`<div class="division-v6003-more" hidden><button type="button" data-v6003-go="messages">문자 센터</button><button type="button" data-v6003-go="print">출력 센터</button><button type="button" data-v6003-edit>부서 설정</button></div>`:''}
          </div>`:'';
    ...
    bar.querySelector('[data-v6003-more]')?.addEventListener('click',e=>{
      ...
      e.currentTarget.textContent=menu.hidden?'더보기':'접기';
    });
...
(()=>{
  ...
  console.info('[230MATCH] 61.0.0 ready · one-pass division binding, member/refund continuity, and explicit management save');
})();
