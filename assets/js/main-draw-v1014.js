/* v1014 clean main draw display mode
...
(function(){
  ...
  // v1014 uses its own guard and filename so cached v1008~v1013 scripts cannot block this patch.
  const VERSION = 'v1014-venue-autoqueue-fix';
  ...
  function scheduleAutoQueueResolved(key){
    try{
      ...
      __autoQueueState[key]=setTimeout(()=>{ __autoQueueState[key]=null; autoQueueResolvedAfterPrelim(key).catch(e=>console.warn('[v1014] auto queue failed',e)); }, 350);
    }catch(e){}
  }
  ...
  function installSharedQueueBridge(){
    ...
    }catch(e){ console.warn('[v1014] shared queue bridge failed', e); }
  }
  function installCourtBoardCleanPatch(){
    ...
    }catch(e){ console.warn('[v1014] court board clean patch failed', e); }
  }
  ...
  try{console.log('[v1014] venue/autoqueue main draw loaded');}catch(e){}
})();
...
(function(){
  ...
  var VERSION='v1014-button-venue-autoqueue-fix';
  function $(id){return document.getElementById(id);}
  ...
  try{console.log('[v1014] main draw buttons cache-proof fixed');}catch(e){}
})();
