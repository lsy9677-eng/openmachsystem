...
(function(){
  ...
  const VERSION = 'v1019-staged-shared-queue-balanced-fix';
  ...
  window.MainDrawCleanV1019={version:VERSION,ensurePanel,generateDraw,assignCourts,autoQueueResolvedAfterPrelim,hideLegacyMainUi,hideLegacyTreeOnly,selectedKey,prelimComplete,resolveCleanMatches,isPrivileged:cleanMainPrivileged,normalizeCleanMatchDisplay,nameOnlyFromLabel,venueKo,mainCourts,venueGroups,promoteSharedToOpenSlots,refreshLiveMainQueue,balancedIndexOrder,assignQueueSeqBySegments,mainQueueNumber};
  ...
  try{console.log('[v1019] staged shared queue balanced draw loaded');}catch(e){}
})();
...
/* v1019: live main queue watchdog
...
(function(){
  ...
  try{console.log('[v1019] staged queue watchdog installed');}catch(e){}
})();
