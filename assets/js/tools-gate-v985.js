...
(function(){
  'use strict';
  if(window.__v985StrictPublicToolGateInstalled) return;
  window.__v985StrictPublicToolGateInstalled = true;
  ...
  function apply(){
    ...
    document.documentElement.classList.toggle('v985-priv-tools', ok);
    ...
    document.body.classList.toggle('v985-public-tools-hidden', !ok);
    ...
    try{ const b=$('bracketFreshnessBadge'); if(b) b.textContent='v985 도구권한정리 DEV'; }catch(e){}
  }

  window.v985ApplyStrictPublicToolGate = apply;
