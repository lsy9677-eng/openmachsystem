/* v1016 clean main draw live queue mode
...
(function(){
  'use strict';
  if(window.__V1016_MAIN_DRAW_CLEAN_INSTALLED) return;
  window.__V1016_MAIN_DRAW_CLEAN_INSTALLED = true;
  // v1016 uses its own guard and filename so cached v1008~v1014 scripts cannot block this patch.
  const VERSION = 'v1016-live-main-queue-status-fix';
  ...
  function repairSegmentVenues(key, forceRecompute){
    ...
    }catch(e){ console.warn('[v1016] venue repair failed', e); return {changed:false, venues:[]}; }
  }
  ...
  function scheduleAutoQueueResolved(key){
    try{
      ...
      __autoQueueState[key]=setTimeout(()=>{ __autoQueueState[key]=null; autoQueueResolvedAfterPrelim(key).catch(e=>console.warn('[v1016] auto queue failed',e)); }, 350);
    }catch(e){}
  }
  ...
  function installResultSaveQueueHook(){
    try{
      ...
      const wrapped=async function(){
        ...
        try{ r=await oldSave.apply(this,arguments); }
          ...
          [120,650,1500,3000].forEach(ms=>setTimeout(()=>{ try{ refreshLiveMainQueue(key,'after_result_save').catch(e=>console.warn('[v1016] after save queue failed',e)); }catch(e){} },ms));
        }
        return r;
      };
    ...
    }catch(e){ console.warn('[v1016] result save hook failed', e); }
  }
  function install(){
  ...
  function installSharedQueueBridge(){
    ...
    }catch(e){ console.warn('[v1016] shared queue bridge failed', e); }
  }
  function installCourtBoardCleanPatch(){
    ...
    }catch(e){ console.warn('[v1016] court board clean patch failed', e); }
  }
  window.MainDrawCleanV1016={version:VERSION,ensurePanel,generateDraw,assignCourts,autoQueueResolvedAfterPrelim,hideLegacyMainUi,hideLegacyTreeOnly,selectedKey,prelimComplete,resolveCleanMatches,isPrivileged:cleanMainPrivileged,normalizeCleanMatchDisplay,nameOnlyFromLabel,venueKo,mainCourts,venueGroups,promoteSharedToOpenSlots,refreshLiveMainQueue};
  window.MainDrawCleanV1015=window.MainDrawCleanV1016; window.MainDrawCleanV1014=window.MainDrawCleanV1016;
  window.MainDrawCleanV1013=window.MainDrawCleanV1016;
  window.MainDrawCleanV1012=window.MainDrawCleanV1016; window.MainDrawCleanV1010=window.MainDrawCleanV1016; window.MainDrawCleanV1007=window.MainDrawCleanV1016; window.MainDrawCleanV1004=window.MainDrawCleanV1016; window.MainDrawCleanV1003=window.MainDrawCleanV1016;
  install();
  ...
  try{console.log('[v1016] live main queue/status draw loaded');}catch(e){}
})();
...
(function(){
  ...
  try{console.log('[v1016] main draw buttons cache-proof fixed');}catch(e){}
})();
