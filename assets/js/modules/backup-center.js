...
export function initBackupCenter(api){
  const {getState,registrationContext,registrationRuntime,REGISTRATION_COLLECTION,PUBLIC_REGISTRATION_COLLECTION,getRecoveries,requireAdmin,downloadJson,saveRecovery,notice,exportFullBackup,downloadRecoveryBundle,navigatePortalView,renderBackupRecoveryManager,showRecoveries,restoreStateSnapshot,buildLabel=''}=api;
...
// 5.10.8 · detailed backup link now opens recovery-point list directly.
