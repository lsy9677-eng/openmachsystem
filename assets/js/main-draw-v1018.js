/* v1018 clean main draw randomized queue timer mode
...
(function(){
  'use strict';
  if(window.__V1018_MAIN_DRAW_CLEAN_INSTALLED) return;
  window.__V1018_MAIN_DRAW_CLEAN_INSTALLED = true;
  // v1018 uses its own guard and filename so cached v1008~v1014 scripts cannot block this patch.
  const VERSION = 'v1018-random-draw-live-clock-fix';
  ...
  function scheduleAutoQueueResolved(key){
    try{
      ...
      __autoQueueState[key]=setTimeout(()=>{ __autoQueueState[key]=null; autoQueueResolvedAfterPrelim(key).catch(e=>console.warn('[v1018] auto queue failed',e)); }, 350);
    }catch(e){}
  }
  ...
  function installSharedQueueBridge(){
    ...
    }catch(e){ console.warn('[v1018] shared queue bridge failed', e); }
  }
  function installCourtBoardCleanPatch(){
    ...
    }catch(e){ console.warn('[v1018] court board clean patch failed', e); }
  }
  window.MainDrawCleanV1018={version:VERSION,ensurePanel,generateDraw,assignCourts,autoQueueResolvedAfterPrelim,hideLegacyMainUi,hideLegacyTreeOnly,selectedKey,prelimComplete,resolveCleanMatches,isPrivileged:cleanMainPrivileged,normalizeCleanMatchDisplay,nameOnlyFromLabel,venueKo,mainCourts,venueGroups,promoteSharedToOpenSlots,refreshLiveMainQueue};
  window.MainDrawCleanV1017=window.MainDrawCleanV1018; window.MainDrawCleanV1016=window.MainDrawCleanV1018; window.MainDrawCleanV1015=window.MainDrawCleanV1018; window.MainDrawCleanV1014=window.MainDrawCleanV1018; window.MainDrawCleanV1013=window.MainDrawCleanV1018; window.MainDrawCleanV1012=window.MainDrawCleanV1018; window.MainDrawCleanV1010=window.MainDrawCleanV1018; window.MainDrawCleanV1007=window.MainDrawCleanV1018; window.MainDrawCleanV1004=window.MainDrawCleanV1018; window.MainDrawCleanV1003=window.MainDrawCleanV1018;
  install();
  ...
  try{console.log('[v1018] live main queue/status draw loaded');}catch(e){}
})();
...
(function(){
  ...
  function api(){return window.MainDrawCleanV1018 || window.MainDrawCleanV1017 || window.MainDrawCleanV1016 || window.MainDrawCleanV1015 || window.MainDrawCleanV1014 || window.MainDrawCleanV1010 || window.MainDrawCleanV1007 || window.MainDrawCleanV1004 || window.MainDrawCleanV1003 || window.MainDrawCleanV1002 || null;}
...
/* v1018: live main queue watchdog
...
(function(){
  'use strict';
  if(window.__V1018_MAIN_QUEUE_WATCHDOG_INSTALLED) return;
  window.__V1018_MAIN_QUEUE_WATCHDOG_INSTALLED = true;
  const VERSION='v1018-random-draw-live-clock-fix';
  const S=v=>String(v==null?'':v).trim();
  const ar=v=>Array.isArray(v)?v:[];
  function api(){return window.MainDrawCleanV1018||window.MainDrawCleanV1017||window.MainDrawCleanV1016||window.MainDrawCleanV1015||window.MainDrawCleanV1014||window.MainDrawCleanV1010||null;}
  ...
  try{console.log('[v1018] main queue watchdog installed');}catch(e){}
})();
...
(function(){
  'use strict';
  if(window.__V1018_COURT_CLOCK_FALLBACK_INSTALLED) return;
  window.__V1018_COURT_CLOCK_FALLBACK_INSTALLED = true;
