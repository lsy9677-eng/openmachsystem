...
import{startStateSync,getSyncSettings,saveSyncSettings,connectCloudSync,disconnectCloudSync,pushStateNow,pullStateNow,testCloudConnection,prepareCriticalCloudWrite,deleteTournamentNow,loadTournamentNow}from'./sync-engine-v6500.js?v=6500';
...
document.documentElement.dataset.build='6501';
console.log('[230MATCH] 65.0.1 ready · member-lite core + public records/download support');
