...
const BUILD_LABEL='STAGE 31.43 · LEGACY HOME & ENTRY UI BRIDGE';
const buildStageLabel=document.getElementById('buildStageLabel');
if(buildStageLabel)buildStageLabel.textContent=BUILD_LABEL;
document.documentElement.dataset.build='33143';
console.log('[230MATCH V3] stage31.43 legacy home and entry ui bridge loaded · viewer default · IndexedDB recovery enabled');
