...
import{render,teamText}from'./ui.js?v=3500';
...
import{useUnifiedCourts,prelimPriorityActive,enqueueReadyMainToUnifiedCourts,advanceUnifiedCourt,reconcileUnifiedMainQueues,findUnifiedMatch,moveUnifiedCourtMatchFlexible,reconcilePrelimCourtReservations}from'./unified-court-engine.js?v=3500';
import{ensureMainDrawLifecycle,beginMainDraw,completeMainDraw,failMainDraw,resetMainDraw,hasAuthorizedMainDraw,mainDrawStatus,clearMainPlacement}from'./main-draw-lifecycle-engine.js?v=3500';
...
(function stage3500RebuiltMainLifecycle(){
  ...
  function slotDraw(){
    ...
    try{
      ...
      commit('사용자 실행 · 예선 중 슬롯 본선 추첨 완료');
  ...
  function install(){
    ...
    bindFresh('stage3441Assign',()=>{if(!hasAuthorizedMainDraw(state)){feedback('본선 미추첨 상태입니다. 슬롯 추첨 또는 최종 본선 추첨을 먼저 실행하세요.','error','본선 코트배정');return;}const b=$('assignCourtsBtn');b?b.click():feedback('본선 코트배정 기능을 찾지 못했습니다.','error','본선 코트배정');});
  ...
  const label=$('buildStageLabel');if(label){label.textContent='230MATCH 35.0 · 본선 생명주기 재구축';label.title='Version 35.0.0';}
  document.documentElement.dataset.build='3500';
  console.info('[230MATCH V3] 35.0.0 ready · rebuilt explicit main-draw lifecycle');
})();
