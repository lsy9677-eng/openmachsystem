...
document.documentElement.dataset.build='3410';
console.log('[230MATCH] Stage34.1 operation simplification loaded');
...
(function initCompactOperationWorkspace(){
  ...
  const valid=new Set(['courts','groups','main']);
...
(function stage332Release(){
  const ready=()=>{
    ...
    window.__230MATCH_RELEASE__=Object.freeze({version:'34.1',channel:'release-candidate',label:'230MATCH 운영 화면 단순화 정식 후보본'});
