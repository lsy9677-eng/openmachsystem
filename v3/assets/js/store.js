...
export function initialState(){
  return {
    ...
    settings:{drawSize:64,courtCount:8,courtPrefix:'국제',matchMinutes:40,minimumMatchMinutes:30,autoTimeEnabled:true,timeRefreshSeconds:30,drawMethod:'instant',byePriority:'group-first'},
