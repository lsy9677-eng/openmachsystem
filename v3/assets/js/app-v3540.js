...
/* Stage 35.4.0 · print the existing live main bracket exactly as displayed */
(function stage3532UseExistingBracketForPrint(){
  ...
  function activate(){
    ...
    const label=document.getElementById('buildStageLabel');
    if(label){label.textContent='230MATCH 35.4.0 · 기존 본선 대진표 그대로 출력';label.title='Version 35.4.0';}
  }
  ...
  console.info('[230MATCH V3] 35.4.0 ready · existing live bracket is reused for print and PNG');
})();
