...
const BUILD_LABEL='230MATCH 34.1 · 운영 화면 단순화 V3 테스트본';
...
document.documentElement.dataset.build='3420';
console.log('[230MATCH] Stage34.2 single operation workspace reconstruction');
...
(function stage332Release(){
  const ready=()=>{
    ...
    window.__230MATCH_RELEASE__=Object.freeze({version:'34.2',channel:'test',label:'230MATCH 단일 운영 화면 재구성 테스트본'});
...
(function stage342SingleWorkspace(){
  ...
  function init(){
    ...
    const label=document.getElementById('buildStageLabel');if(label){label.textContent='230MATCH 34.2 · 단일 운영 화면 재구성 테스트본';label.title='Version 34.2';}
    document.documentElement.dataset.build='3420';
