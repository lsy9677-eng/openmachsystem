...
const BUILD_LABEL='STAGE 31.13 · MAIN FLOW INTEGRITY GUARD';
...
console.log('[230MATCH V3] stage31.13 main-flow-integrity-guard loaded · play-in first · no legacy code · no Firebase writes');
