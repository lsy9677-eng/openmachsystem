...
const BUILD_LABEL='STAGE 32.6.5 · REGISTRATION SMS & FULL EDIT DIALOG HOTFIX';
...
function stage3264GuideFor(item){return item?.guide||{date:item?.date||'',venue:item?.venue||'',fee:item?.fee||'',detail:item?.detail||'',bank:'',account:'',paymentNote:''};}
...
console.info('[230MATCH V3] stage32.6.5 loaded · registration SMS and full edit dialog ready');
