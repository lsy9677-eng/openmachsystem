...
const BUILD_LABEL='STAGE 31.11 · PRELIM QUEUE CARD CLEANUP';
...
console.log('[230MATCH V3] stage31.11 prelim-queue-card-cleanup loaded · linked draw strict · no legacy code · no Firebase writes');
