...
const BUILD_LABEL='230MATCH 34.3.1 · 다부서 관리·설정 보완 V3 테스트본';
...
ensureMultiDivisionRuntime();renderDivisionWorkspaceBar();console.info('[230MATCH V3] Stage34.3 multi-division independent operation ready');
...
renderDivisionWorkspaceBar();
console.info('[230MATCH V3] 34.3.1 ready');
