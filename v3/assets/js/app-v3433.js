...
(function(){
  ...
  const label=document.getElementById('buildStageLabel');if(label){label.textContent='230MATCH 34.3.3 · 다부서 생성·설정 흐름 완성 테스트본';label.title='Version 34.3.3';}
  document.documentElement.dataset.build='3433';
  console.info('[230MATCH V3] 34.3.3 ready');
})();
