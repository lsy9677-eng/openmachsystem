...
const BUILD_LABEL='STAGE 31.19 · FLEXIBLE COURT QUEUE INSERT & REORDER';
const buildStageLabel=document.getElementById('buildStageLabel');
if(buildStageLabel)buildStageLabel.textContent=BUILD_LABEL;
document.documentElement.dataset.build='33119';
console.log('[230MATCH V3] stage31.19 flexible-court-queue-insert-reorder loaded · local fallback enabled');
