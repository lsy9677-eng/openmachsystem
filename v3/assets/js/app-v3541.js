...
/* Stage 35.4.1 · compact SMS and balanced 128-draw play-in distribution */
(function stage3532UseExistingBracketForPrint(){
  ...
  function activate(){
    ...
    const label=document.getElementById('buildStageLabel');
    if(label){label.textContent='230MATCH 35.4.1 · 단문 문자·예비전 균등분산';label.title='Version 35.4.1';}
  }
  ...
  console.info('[230MATCH V3] 35.4.1 ready · compact SMS and balanced play-in draw');
})();
