...
(function stage3530ModernCupExactRestore(){
  ...
  function run(){patchProviders();persistExact();refreshViews();installRestoreButton();recoverLegacyPhotos();const label=document.getElementById('buildStageLabel');if(label){label.textContent='230MATCH 35.3.0 · 모던배 정확 기록·사진 복구';label.title='Version 35.3.0';}}
  ...
  console.info('[230MATCH V3] 35.3.0 ready · exact Modern Cup archive and legacy photo recovery active');
})();
