...
const BUILD_LABEL='STAGE 31.16 · ADMIN & OPERATOR ROLES';
const buildStageLabel=document.getElementById('buildStageLabel');
if(buildStageLabel)buildStageLabel.textContent=BUILD_LABEL;
document.documentElement.dataset.build='33116';
console.log('[230MATCH V3] stage31.16 admin-operator-roles loaded · play-in first · no legacy code · no Firebase writes');
