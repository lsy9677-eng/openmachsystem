...
(()=>{document.documentElement.dataset.build='6113';console.info('[230MATCH] 62.0.1 ready · compact mobile operation workspace');})();

console.info('[230MATCH] 62.0.0 core · single Firestore listener, lightweight save events, Storage-decoupled editor');

console.info('[230MATCH] 62.0.1 UI · compact mobile tournament/division workspace');
