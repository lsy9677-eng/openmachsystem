import{getAuthConfig,saveAuthConfig,startAuth,signInGoogle,signOutSocial,beginExternalLogin,getExistingLoginEndpoints}from'./auth-engine.js?v=332014';
import{getAuthRuntime}from'./auth-engine.js?v=332014';
...
const BUILD_LABEL='STAGE 32.1.2 · FIREBASE SDK & NAVER RETURN HOTFIX';
...
document.getElementById('mobileSocialLoginBtn')?.addEventListener('click',()=>{closeMobileMoreMenu();openSocialLogin();});
...
document.documentElement.dataset.build='332014';
console.log('[230MATCH V3] stage32.1.4 mobile login access hotfix loaded');
