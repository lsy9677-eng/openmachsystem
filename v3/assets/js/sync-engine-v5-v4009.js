...
function normalizeRecords(state){
  ...
  if(state?.multiTournament?.noActiveTournament===true&&!(state?.multiTournament?.tournaments||[]).length)return{activeId:'',rows:[]};
