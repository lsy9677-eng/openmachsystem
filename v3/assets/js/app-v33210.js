...
const BUILD_LABEL='STAGE 32.10 · CURRENT TOURNAMENT & VENUE CONFIGURATION';
...
console.info('[230MATCH V3] stage32.6.5 loaded · admin registration edit/delete and tournament quick links ready');
...
console.info('[230MATCH V3] stage32.6.6 loaded · registration SMS message hotfix ready');
...
console.info('[230MATCH V3] stage32.8 loaded · tournament-list guide and image download ready');


// Stage 32.8.1 · tournament guide routing hotfix
console.info('[230MATCH V3] stage32.8.1 loaded · hidden public guide view routing ready');
...
console.info('[230MATCH V3] stage32.9 loaded · tournament edit and role-based menu hub ready');
...
function stage3210CleanSettings(){document.querySelectorAll('.auth-settings-section,#firebaseLiveSyncSection,.draw-history-section,.feature-roadmap,.venue-settings-section').forEach(el=>el.hidden=true);document.querySelectorAll('[data-settings-action="firebase-sync"]').forEach(el=>el.remove());const tab=document.querySelector('[data-view="settings"]');if(tab)tab.textContent='현재 대회 설정';stage3210RenderSettingsSummary();}
...
console.info('[230MATCH V3] stage32.10 loaded · current tournament venue configuration ready');
