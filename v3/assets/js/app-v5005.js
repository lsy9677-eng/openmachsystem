...
(function stage3569RuntimeAndCourtRouteFix(){
  ...
  if(document.readyState==='loading')document.addEventListener('DOMContentLoaded',apply,{once:true});else apply();
  console.info('[230MATCH] 50.0.5 ready · tournament list select/edit/delete integrated');
})();
...
document.documentElement.dataset.build='5005';
console.info('[230MATCH] 50.0.5 final · all tournaments visible with select/edit/delete');
